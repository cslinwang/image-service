...
use nydus_builder::{
    ...
    BuildContext, BuildOutput, Builder, ChunkdictChunkInfo, ConversionType, DirectoryBuilder,
    Feature, Features, Generater, HashChunkDict, Merger, Prefetch, PrefetchPolicy, StargzBuilder,
...
impl Command {
    ...
    fn chunkdict_dump(
        ...
        build_ctx.configuration = config.clone();
